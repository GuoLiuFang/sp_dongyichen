        ...
        if not isValid:
            ...
            csvlist.append(
                (
                    ...
                    messageContent[index][4], messageContent[index][5], messageContent[index][6],
                    messageContent[index][7],
            ...
            if status > -1:
                ...
                if chargeStr == -1:
                    ...
                    csvlist.append((
                        ...
                        chargeStr[1], chargeStr[2], chargeStr[3], chargeStr[4], chargeStr[5], chargeStr[6],
                        chargeStr[7],
                        chargeStr[8]))
                    continue
            else:
...
with open("/data/sdg/guoliufang/mysqloutfile/sqlList.txt") as f:
    for line in f:
        print line
        exe(line)
